...
```{r plotRiskAll, echo = FALSE, warning = FALSE, fig.cap = 'Estimated and true relative risk', fig.subcap = as.vector(rbind(paste('est ', 1:length(xvAllKentucky$bw), gsub("bw", ", bw=", xvAllKentucky$bw), sep = ' '), paste('truth ', 1:length(xvAllKentucky$bw)))), fig.height = 3, fig.width = 6, out.width = theWidth, fig.ncol = 2}
