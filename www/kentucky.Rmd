...
```{r plotExcProbOne, echo = FALSE, warning = FALSE, fig.cap = 'Exceedance Probabilities for Simulation 1', fig.subcap = paste('Threshold ', threshold, sep = ''), fig.height = 3, fig.width = 6, out.width = theWidth, fig.ncol = 2}
