...
```{r plotRiskAll, echo = FALSE, warning = FALSE, fig.cap = 'Estimated and True Relative Risk', fig.subcap = as.vector(rbind(paste('est ', 1:length(lemXvGTA$bw), ', bw=', as.numeric(gsub("^bw", "", lemXvGTA$bw)) / 1000, ' km', sep = ''), paste('truth ', 1:length(lemXvGTA$bw), sep = ''))), fig.height = 3, fig.width = 6, out.width = theWidth, fig.ncol = 2}
