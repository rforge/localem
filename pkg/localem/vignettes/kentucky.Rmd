...
```{r cvNewAll, cache=(basename(getwd())=='www'), cache.path='cache'}
library('localEM')
xvAll = lemXv(
...
```{r cvPlotAll, fig.cap='cross validation scores', fig.height=4, fig.width=6, out.width = '80%', fig.ncol=NULL}
...
```{r finalStep, cache=(basename(getwd())=='www'), cache.path='cache'}
