...
```{r plotOffset, echo = FALSE, warning = FALSE, fig.cap = 'Events for Simulation 1', fig.subcap = c('Offset', 'Relative Intensity', 'Events', 'Counts'), fig.height = 4, fig.width = 6, out.width = '80%', fig.ncol = NULL}
...
```{r plotRiskAll, echo = FALSE, warning = FALSE, fig.cap = 'Risk Estimation with Optimal Bandwidths', fig.subcap = paste('Simulation ', 1:4, sep = ''), fig.height = 4, fig.width = 6, out.width = '80%', fig.ncol = NULL}
...
```{r riskOne, eval = FALSE, purl = FALSE, include = FALSE, warning = FALSE}
...
```{r plotRiskOne, eval = FALSE, purl = FALSE, include = FALSE, echo = FALSE, warning = FALSE, fig.cap = 'Risk Estimation for Simulation 1', fig.subcap = paste('Risk, bw=', Sbw / 1000, ' km', sep = ''), fig.height = 4, fig.width = 6, out.width = '80%', fig.ncol = NULL}
...
```{r excProbOne, eval = FALSE, purl = FALSE, include = FALSE, warning = FALSE}
...
```{r plotExcProbOne, eval = FALSE, purl = FALSE, include = FALSE, echo = FALSE, warning = FALSE, fig.cap = 'Exceedance Probabilities for Simulation 1', fig.subcap = paste('Threshold ', threshold, sep = ''), fig.height = 4, fig.width = 6, out.width = '80%', fig.ncol = NULL}
