...
```{r smoothingMatrix, cache=TRUE,stuff=1}
...
matplot(lemRoc[,1], lemRoc[,c(2,3)], ylab='sens', 
	xlab='1-spec', type='l', col=2:3)
legend("bottomright", lty=1, col=2:3, 
