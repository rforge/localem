...
lemCvNewKentucky = lemXv(   
  ...
  verbose = TRUE)
if(Sys.info()['user'] == 'patrick') {
	save(lemCvKentucky, file='lemCvKentucky.RData')
}  
```

```{r cvPlotNew}

plot(lemCvNewKentucky$xv[,1]/1000, lemCvNewKentucky$xv[,2], xlab='km', ylab='-log p', 
    type='o', ylim=quantile(lemCvNewKentucky$xv[,2], c(0,0.5)))
