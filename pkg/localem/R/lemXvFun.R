...
lemXv = function(
	...
	##raster partition
	# this used to be inside the loop
	# does it need to be?
 ...
 xvSmoothMat =  smoothingMatrix(
	...
	Scells = ifelse(all(is.na(values(xvRasterFine[["cellCoarse"]]))) | 
					all(is.na(values(xvRasterFine[["idCoarse"]]))), 
			NA, 
